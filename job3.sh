...
#SBATCH --ntasks=1
#SBATCH --array=0-15
#SBATCH --job-name=ai2-arc-gemma_quantisation_6k
#SBATCH --mem=10GB
...
python -m src.main --model gemma9b --backend llama_cpp --start ${START_INDEX} --end ${END_INDEX} --task ai2_arc --quantisation 6
