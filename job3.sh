...
#SBATCH --ntasks=1
#SBATCH --array=0-15
#SBATCH --job-name=cqa-llama_quantisation_6k
#SBATCH --mem=10GB
...
python -m src.main --model llama3 --backend llama_cpp --start ${START_INDEX} --end ${END_INDEX} --task CommonsenseQA --quantisation 6
