...
#SBATCH --ntasks=1
#SBATCH --array=0-15
#SBATCH --job-name=cqa-gemma_quantisation_4k
#SBATCH --mem=10GB
...
python -m src.main --model gemma9b --backend llama_cpp --start ${START_INDEX} --end ${END_INDEX} --task CommonsenseQA --quantisation 4
