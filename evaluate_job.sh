...
#SBATCH --job-name=eval-ai2_arc-deepseek-quant4-part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model deepseek --index ${START_INDEX} --method cosine --task ai2_arc --quantisation 4
