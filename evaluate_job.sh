...
#SBATCH --job-name=eval-gsm8k-gemma-quant4-part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model gemma9b --index ${START_INDEX} --method cosine --task GSM8K --quantisation 4
