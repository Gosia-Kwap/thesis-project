...
#SBATCH --job-name=eval_asdiv_deepseek_quant4_part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model deepseek --index ${START_INDEX} --method cosine --task ASDiv --quantisation 4
