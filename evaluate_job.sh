...
#SBATCH --job-name=eval_asdiv_gemma_quant6_part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model gemma9b --index ${START_INDEX} --method cosine --task ASDiv --quantisation 6
