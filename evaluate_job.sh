...
#SBATCH --job-name=eval-logiqa-gemma-quant6-part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model gemma9b --index ${START_INDEX} --method cosine --task logiqa --quantisation 6
