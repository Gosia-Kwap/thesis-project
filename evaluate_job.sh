...
#SBATCH --job-name=eval-gsm8k-llama3-quant6-part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model llama3 --index ${START_INDEX} --method cosine --task GSM8K --quantisation 6
