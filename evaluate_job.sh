...
#SBATCH --job-name=eval_ai2arc_gemma_quant4_part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model gemma9b --index ${START_INDEX} --method cosine --task ai2_arc --quantisation 4
