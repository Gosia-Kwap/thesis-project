...
#SBATCH --job-name=eval-cqa-llama-quant6part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model llama3 --index ${START_INDEX} --method cosine --task CommonsenseQA --quantisation 6
