...
#SBATCH --job-name=eval_ai2arc_deepseek_quant6_part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model deepseek --index ${START_INDEX} --method cosine --task ai2_arc --quantisation 6
