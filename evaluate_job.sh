...
#SBATCH --job-name=eval-logiqa-llama-quant4-part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model llama3 --index ${START_INDEX} --method cosine --task logiqa --quantisation 4
