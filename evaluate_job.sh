...
#SBATCH --job-name=eval-cqa-gemma-quant6part1
#SBATCH --mem=10GB
...
python -m src.evaluate_uncertainty --model gemma9b --index ${START_INDEX} --method cosine --task CommonsenseQA --quantisation 6
